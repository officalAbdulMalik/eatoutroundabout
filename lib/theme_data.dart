...
theme() {
  ...
  return ThemeData(
    ...
    textTheme: TextTheme(titleLarge: textStyle(textSize), bodyMedium: textStyle(textSize), titleSmall: TextStyle(color: primaryColor, fontWeight: FontWeight.bold, fontFamily: 'Font2', fontSize: textSize)),
