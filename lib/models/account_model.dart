...
class Account {
  ...
  final bool? isCommunityPartner;
  final bool? isRecruitmentPartner;
  final bool? isHospitalityPartner;
  ...
  Account({
    ...
    this.isVenueAccount,
    this.isPartner,
    this.isCommunityPartner,
    this.isRecruitmentPartner,
    this.isHospitalityPartner,
    this.noEmployees,
    this.postcode,
    this.streetAddress,
    this.telephone,
  ...
  factory Account.fromDocument(Map<String, dynamic> doc) {
    return Account(
      ...
      isCommunityPartner: doc['isCommunityPartner'] ?? false,
      isRecruitmentPartner: doc['isRecruitmentPartner'] ?? false,
      isHospitalityPartner: doc['isHospitalityPartner'] ?? false,
      ...
      creationDate:
          doc['creationDate'] ?? Timestamp.fromDate(DateTime(2021, 1, 1)),
      membershipExpiryDate: doc['membershipExpiryDate'] ??
          doc['creationDate'] ??
          Timestamp.fromDate(DateTime(2021, 1, 1)),
      eventExpiryDate: doc['eventExpiryDate'] ??
          doc['creationDate'] ??
          Timestamp.fromDate(DateTime(2021, 1, 1)),
      productExpiryDate: doc['productExpiryDate'] ??
          doc['creationDate'] ??
          Timestamp.fromDate(DateTime(2021, 1, 1)),
      offerExpiryDate: doc['offerExpiryDate'] ??
          doc['creationDate'] ??
          Timestamp.fromDate(DateTime(2021, 1, 1)),
      isNewAccount: doc['isNewAccount'] ?? false,
    );
    /*try {
      return Account(
        ...
        isCommunityPartner: doc['isCommunityPartner'] as bool?? false,
        isRecruitmentPartner: doc['isRecruitmentPartner'] as bool?? false,
        isHospitalityPartner: doc['isHospitalityPartner'] as bool?? false,
        noEmployees: doc['noEmployees']as num,
  ...
  Map<String, Object> toJson() {
    return {
      ...
      'isRecruitmentPartner': isRecruitmentPartner!,
      'isHospitalityPartner': isHospitalityPartner!,
