...
class User {
 ...
 // bool? unreadBadges;
  ...
  final bool? possAccount;
  final String? liveMembershipID;
  final List? helpMainCategories;
  ...
  User({
    ...
    this.possAccount,
    this.liveMembershipID,
    this.helpMainCategories,
  });
  ...
  factory User.fromDocument(Map<String, dynamic> doc) {
    return User(
     ...
     // unreadBadges: doc['unreadBadges'] ?? false,
      ...
      memberSince: doc['memberSince'] ?? doc['memberSince'] ?? Timestamp.fromDate(DateTime(2024, 1, 1)),
      recommendationID: doc['recommendationID'] ?? '',
      possAccount: doc['possAccount'] ?? false,
      liveMembershipID: doc['liveMembershipID'] ?? '',
      helpMainCategories: doc['helpMainCategories'] ?? [],
    );
   /* try {
      return User(
  ...
  Map<String, Object> toJson() {
    return {
      ...
      'possAccount': possAccount!,
      'liveMembershipID': liveMembershipID!,
      'helpMainCategories': helpMainCategories!,
    };
  }
}
