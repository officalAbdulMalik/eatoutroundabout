...
class BusinessProfile {
  ...
  BusinessProfile({
    ...
    this.lm3ImpactValue,
    this.website,
    this.svProfileRating,
    this.socialValueScore,
  });
  ...
  factory BusinessProfile.fromDocument(Map<String, dynamic> doc) {
    return BusinessProfile(
      ...
      website: doc['website'] ?? '',
      svProfileRating: doc['svProfileRating'] ?? 0,
      socialValueScore: doc['socialValueScore'] ?? 0,
    );
    try {
      return BusinessProfile(
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'website': website,
      'svProfileRating': svProfileRating,
