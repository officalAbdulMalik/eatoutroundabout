            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Divider(),
                  Row(
                    children: [Text(event!.buildingName! + ', ' + event!.streetAddress! + ', ' + event!.postCode!, textScaleFactor: 0.85, style: TextStyle(color: primaryColor, )),
                  ]),
                  Row(
                    children: [
                      Expanded(
                        child: Text(textScaleFactor: 0.85, DateFormat('dd MMM yyyy, hh:mm aa').format(event!.eventDateTimeFrom!.toDate())),
                      ),
                      Container(
