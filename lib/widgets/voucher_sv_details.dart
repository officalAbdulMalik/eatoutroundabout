...
class VoucherSVDetails extends StatelessWidget {
  final Voucher? voucher;

  VoucherSVDetails({this.voucher});
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(voucher!.issuedCampaignName!, textScaleFactor: 1.25, textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold)),
                ),
                Text(voucher!.displayMessage!, style: TextStyle(color: greenColor, fontWeight: FontWeight.bold)),
              ],
            ),
          ),
          Divider(height: 1),
