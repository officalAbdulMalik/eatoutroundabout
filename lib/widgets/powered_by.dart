...
class PoweredBy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      FutureBuilder<QuerySnapshot<BusinessProfile>>(
          future: firestoreService.getPoweredBy(featuredType!),
          builder: (context, AsyncSnapshot<QuerySnapshot<BusinessProfile>> snapshot) {
            if (!snapshot.hasData)
              ...
              return InkWell(
                ...
                child: Row(
                  children: [
                    if (featuredType == 'venue')
                    Text('Sponsors -'),
                    if (featuredType == 'business')
                      Text('Sponsors -'),
                    if (featuredType == 'consumer')
                      Text('Our Champions -'),
                    Expanded(
                      child: Swiper(
                        autoplay: true,
