          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextField(controller: promoCodeTEC, label: 'Promo Code (if you have one)', hint: 'Enter promo code'),
                Obx(() {
                ...
                Obx(() {
                  return CheckboxListTile(
                    ...
                    controlAffinity: ListTileControlAffinity.leading,
                    title: Text(
                      'I would like to receive marketing updates from Eat Out Round About',
                      textScaleFactor: 0.95,
                      maxLines: 4,
                      style: TextStyle(color: Colors.teal),
                    ),
                    value: isMarketing.value,
                    onChanged: (bool? value) {
                      possAccount.value = value!;
                    },
                  );
                }),
                Obx(() {
                  return CheckboxListTile(
                    ...
                    controlAffinity: ListTileControlAffinity.leading,
                    title: Text(
                      'I represent a business, organisation or venue',
                      textScaleFactor: 0.95,
                      maxLines: 4,
                      style: TextStyle(color: Colors.teal),
                    ),
                    value: possAccount.value,
                    onChanged: (bool? value) {
                      possAccount.value = value!;
                    },
                  );
