          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                // if(userController.currentUser.value.liveMembershipID!.isNotEmpty)
                  Center(child: Text('Member since : ' + DateFormat('dd MMM yyyy').format(userController.currentUser.value.memberSince!.toDate()), textScaleFactor: 1, style: TextStyle(color: primaryColor))),
                  ...
                  InkWell(
                    ...
                    child: ColorCard(title: 'Social value made easy!', subTitle: 'Are you from a company seeking to create social value? Create a free account to get involved', color: purpleColor),
                  ),
                  InkWell(
                    onTap: () async {
                      if (userController.currentUser.value.accountID != null && userController.currentUser.value.accountID != '') {
                    ...
                    child: ColorCard(title: 'Helping hospitality', subTitle: 'Benefit from local public spending and a fully funded suite of tools to boost your hospitality business', color: orangeColor),
                  ),
                  InkWell(
                    onTap: () async {
                      if (userController.currentUser.value.accountID != null && userController.currentUser.value.accountID != '') {
                    ...
                    child: ColorCard(title: 'Small businesses!', subTitle: 'Are you a supplier to hospitality, or run a hospitality pop-up without a venue? Create a free account to get involved', color: greenColor),
                  ),

                  InkWell(
                    onTap: () => Get.to(() => RecommendVenue()),
                    child: ColorCard(title: 'Can\'t find your favourite venue?', subTitle: 'Make a recommendation and we\'ll contact them to join us!', color: redColor),
                  ),
                ],
              ),
            ),
