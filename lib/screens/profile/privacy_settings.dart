            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Divider(height: 50),
                  setting(0, 'email me restaurant, pop-ups and recommendation updates'),
                  setting(1, 'email ideas to help my local economy'),
                  setting(2, 'Allow push notifications'),
                  setting(3, 'Would you like us to present your profile for others to connect? (coming soon)'),
                  setting(4, 'Would you like to be visible when attending organised events?'),
                  setting(5, 'Share my details in the social network (coming soon)'),
