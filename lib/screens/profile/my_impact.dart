...
class _MyImpactState extends State<MyImpact> {
                                  ...
                                  Align(
                                    ...
                                    child: CircleAvatar(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text('You have', textScaleFactor: 1, textAlign: TextAlign.center, style: TextStyle(color: Colors.white70)),
                                          Text('generated', textScaleFactor: 1, textAlign: TextAlign.center, style: TextStyle(color: Colors.white70)),
                                          Padding(
                                          ...
                                          Text('for your', textScaleFactor: 1, textAlign: TextAlign.center, style: TextStyle(color: Colors.white70)),
                                          Text('local economy', textScaleFactor: 1, textAlign: TextAlign.center, style: TextStyle(color: Colors.white70)),
  ...
  redCircle(Badge badge, context) {
    return Container(
      ...
      child: Stack(
        children: [
          Center(child: ArcText(radius: 85, text: '       Environmentally Friendly', textStyle: TextStyle(color: Colors.white), startAngle: -196, startAngleAlignment: StartAngleAlignment.start, placement: Placement.outside, direction: Direction.clockwise)),
          Center(
            child: CircleAvatar(
              ...
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text('Your estimated', textScaleFactor: 1, textAlign: TextAlign.center, style: TextStyle(color: Colors.white70)),
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 2),
                    child: Text(badge.impactLm1 != 0 ? '${(badge.impactLm2! / badge.impactLm1!).toStringAsFixed(1)}KG' : '0', textAlign: TextAlign.center, textScaleFactor: 2, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                  ),
                  Text('carbon footprint', textScaleFactor: 1, textAlign: TextAlign.center, style: TextStyle(color: Colors.white70)),
                ],
              ),
            ),
          ),
  ...
  greenCircle(Badge badge, context) {
    return Container(
      ...
      child: Stack(
        children: [
          Center(child: ArcText(radius: 85, text: '   Supporting local jobs', textStyle: TextStyle(color: Colors.white), startAngle: -196, startAngleAlignment: StartAngleAlignment.start, placement: Placement.outside, direction: Direction.clockwise)),
          Center(
            child: CircleAvatar(
              ...
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text('You have supported', textScaleFactor: 1, textAlign: TextAlign.center, style: TextStyle(color: Colors.white70)),
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 2),
                    child: Text(badge.impactLm1 != 0 ? '${(badge.impactLm3!).toStringAsFixed(0)}' : '0', textAlign: TextAlign.center, textScaleFactor: 2, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                  ),
                  Text('jobs', textScaleFactor: 1, textAlign: TextAlign.center, style: TextStyle(color: Colors.white70)),
                ],
              ),
            ),
          ),
