...
class _DietaryPreferencesState extends State<DietaryPreferences> {
  ...
  final vegetarian = false.obs, vegan = false.obs, dairyFree = false.obs, kosher = false.obs, halal = false.obs, paleo = false.obs, ketogenic = false.obs, checkMarketing = true.obs;
  ...
  void initState() {
    ...
    dairyFree.value = userController.currentUser.value.dairyFree!;
    kosher.value = userController.currentUser.value.kosher!;
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 15),
                  Text('Add your dietary preferences and Eat Out Round About will make suggestions on where to eat out.', textAlign: TextAlign.justify),
                  Divider(height: 50),
  ...
  setValue(int i, bool value) {
    switch (i) {
      ...
      case 3:
        return kosher.value = value;
      case 4:
        return paleo.value = value;
      case 5:
        return ketogenic.value = value;
      case 6:
        return dairyFree.value = value;
