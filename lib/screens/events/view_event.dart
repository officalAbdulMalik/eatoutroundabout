                                  ...
                                  children: [
                                    ...
                                    if (event!.pricePerHead! > 0)
                                      Container(
                                        ...
                                        child: Text('£' + event!.pricePerHead.toString() + ' per head', textScaleFactor: 0.75),
                                      ),
                                  ],
                                ),
                              ),
                              ...
                              Card(
                                child: Padding(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('Location', style: TextStyle(fontWeight: FontWeight.bold, color: greenColor)),
                                      SizedBox(height: 10),
                                      Text(event!.buildingName! + ', '+ event!.streetAddress! + ', ' + event!.townCity! + ', ' + event!.postCode!, textAlign: TextAlign.justify),
                                    ],
                                  ),
                                ),
                              ),
                              CustomListTile(
                                onTap: () => Get.to(() => PopUpStalls(eventID: event!.eventID)),
                                leading: Icon(Icons.restaurant, color: primaryColor),
                                title: Text('Participating food outlets', style: TextStyle(color: primaryColor)),
