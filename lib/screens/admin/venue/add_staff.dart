                          ...
                          builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                            if (snapshot.hasData)
                              return snapshot.data!.docs.length > 0
                                  ...
                                  : EmptyBox(text: 'No Team added yet');
                            else
                              return LoadingData();
                          },
                        ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text('- Can add other staff', textScaleFactor: 0.85, style: TextStyle(color: Colors.grey)),
                                      ],
                                    ),
                                  ),
                                ],
