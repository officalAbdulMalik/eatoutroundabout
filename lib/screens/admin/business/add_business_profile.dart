...
class AddBusinessProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Heading(title: 'ADD A PROFILE', textScaleFactor: 1.75),
          Expanded(
            child: Form(
              key: formKey,
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    Text('Create a new social value profile to track and promote impact with multiple profiles e.g. by location'),
                    SizedBox(height: 20),
                    InkWell(
                      onTap: () async {
