...
class SocialValueReportItemDetails extends StatelessWidget {
  final SocialValue? socialValue;

  SocialValueReportItemDetails({this.socialValue});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          //         child: Text(socialValueProjects!.projectName!, textScaleFactor: 1.25, textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold)),
          //       ),
          //       Text(socialValueProjects!.summary!, style: TextStyle(color: greenColor, fontWeight: FontWeight.bold)),
          //     ],
          //   ),
          // ),
          Divider(height: 1),
