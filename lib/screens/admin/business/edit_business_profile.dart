...
class _EditBusinessProfileState extends State<EditBusinessProfile> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Heading(title: 'EDIT SOCIAL VALUE PROFILE', textScaleFactor: 1.75),
          Expanded(
            child: Form(
              key: formKey,
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    CustomTextField(
                        validate: true,
                        label: 'Social Value Profile Name *',
                        hint: 'Enter the name of the business or organisation you want to represent',
                    ...
                    CustomButton(
                      ...
                      function: () async {
                        ...
                        Get.back();
                        Get.back();
                        showGreenAlert('Social Value Profile updated successfully');
                      },
                    ),
                  ],
                ),
