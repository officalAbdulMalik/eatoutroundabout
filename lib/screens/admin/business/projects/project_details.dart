...
class ProjectDetails extends StatelessWidget {
  final Projects? socialValueProjects;

  ProjectDetails({this.socialValueProjects});
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(socialValueProjects!.projectType!, style: TextStyle(color: greenColor, fontWeight: FontWeight.bold)),
              ],
            ),
          ),
          Divider(height: 1),
