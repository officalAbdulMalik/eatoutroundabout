...
class SocialValueReportTypes extends StatelessWidget {
  final Projects? projects;

  SocialValueReportTypes({this.projects});
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(projects!.projectName!, textScaleFactor: 1.25, textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold)),
                ),
                Text(projects!.summary!, style: TextStyle(color: greenColor, fontWeight: FontWeight.bold)),
              ],
            ),
          ),
          Divider(height: 1),
