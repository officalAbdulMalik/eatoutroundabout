                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 15),
                            Text('Category: ' + projects!.projectType!),
                            Text('Created On: ' + DateFormat('dd MMM yyyy').format(projects!.projectStartDate!.toDate()), textScaleFactor: 0.9, style: TextStyle(color: Colors.grey)),
                            SizedBox(height: 15),
                            //if (product.businessName != '') Text('Sold by: ' + product.businessName),
                            if (projects!.businessProfileID != '')
                              InkWell(
                                  onTap: () async {
                                    DocumentSnapshot doc = await firestoreService.getBusinessByBusinessID(projects!.businessProfileID!);
