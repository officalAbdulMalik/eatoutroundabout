...
class CommunityReferrals extends StatefulWidget {
  final userController = Get.find<UserController>();

  @override
  _CommunityReferralsState createState() => _CommunityReferralsState();
}

class _CommunityReferralsState extends State<CommunityReferrals> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          Heading(title: 'REFERRAL REPORT', textScaleFactor: 1.5),
          Text('Coming Soon'),
          // Expanded(
          //   child: Container(
