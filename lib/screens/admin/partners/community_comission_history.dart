...
class CommunityComissionHistory extends StatefulWidget {
  final userController = Get.find<UserController>();

  @override
  _CommunityComissionHistoryState createState() => _CommunityComissionHistoryState();
}

class _CommunityComissionHistoryState extends State<CommunityComissionHistory> {
