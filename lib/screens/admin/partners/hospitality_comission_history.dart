...
class HospitalityCommissionHistory extends StatefulWidget {
  final userController = Get.find<UserController>();

  @override
  _HospitalityCommissionHistoryState createState() => _HospitalityCommissionHistoryState();
}

class _HospitalityCommissionHistoryState extends State<HospitalityCommissionHistory> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          Heading(title: 'Payment History', textScaleFactor: 1.5),
          Text('Coming Soon'),
          // Expanded(
          //   child: Container(
