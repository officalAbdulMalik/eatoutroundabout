...
class ViewNHSSocialValueProjectDetails extends StatelessWidget {
  final Projects? projects;

  ViewNHSSocialValueProjectDetails({this.projects});
            ...
            child: Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    InkWell(
                      onTap: () => Get.to(() => ViewImages(images: [projects!.logo], index: 0)),
                      child: SizedBox(height: Get.height * 0.25, child: CachedImage(url: projects!.logo, height: Get.width)),
                    ),
                    SizedBox(height: 15),
                    Card(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(projects!.projectName!, style: TextStyle(color: Colors.teal.shade400, fontWeight: FontWeight.bold)),
                            SizedBox(height: 15),
                            Text('Start Date: ' + DateFormat('dd MMM yyyy').format(projects!.projectStartDate!.toDate()), textScaleFactor: 0.9, style: TextStyle(color: Colors.grey)),
                            SizedBox(height: 15),
                            Text('End Date: ' + DateFormat('dd MMM yyyy').format(projects!.projectEndDate!.toDate()), textScaleFactor: 0.9, style: TextStyle(color: Colors.grey)),
                            SizedBox(height: 15),
                            //if (product.businessName != '') Text('Sold by: ' + product.businessName),
                            // if (socialValueProjects!.donationBusinessProfileID != '')
                            //   InkWell(
                            //       onTap: () async {
