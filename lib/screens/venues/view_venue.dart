          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (venue!.allergies!.isNotEmpty && venue!.intolerances!.isEmpty)
                Card(
                  child: Padding(
                    padding: const EdgeInsets.all(padding),
                    child: Column(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Divider(),
                        day('Monday', '${venue!.monday!.open!.toStringAsFixed(2)} - ${venue!.monday!.close!.toStringAsFixed(2)}'),
                        Divider(),
                        day('Tuesday', '${venue!.tuesday!.open!.toStringAsFixed(2)} - ${venue!.tuesday!.close!.toStringAsFixed(2)}'),
                        Divider(),
                        day('Wednesday', '${venue!.wednesday!.open!.toStringAsFixed(2)} - ${venue!.wednesday!.close!.toStringAsFixed(2)}'),
                        Divider(),
                        day('Thursday', '${venue!.thursday!.open!.toStringAsFixed(2)} - ${venue!.thursday!.close!.toStringAsFixed(2)}'),
                        Divider(),
                        day('Friday', '${venue!.friday!.open!.toStringAsFixed(2)} - ${venue!.friday!.close!.toStringAsFixed(2)}'),
                        Divider(),
                        day('Saturday', '${venue!.saturday!.open!.toStringAsFixed(2)} - ${venue!.saturday!.close!.toStringAsFixed(2)}'),
                        Divider(),
                        day('Sunday', '${venue!.sunday!.open!.toStringAsFixed(2)} - ${venue!.sunday!.close!.toStringAsFixed(2)}'),
                      ],
                    ),
                  ),
                ),
