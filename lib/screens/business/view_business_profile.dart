                    ...
                    Card(
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Website', style: TextStyle(color: Colors.teal.shade400, fontWeight: FontWeight.bold)),
                            SizedBox(height: 15),
                            Text(businessProfile!.website!, textAlign: TextAlign.justify),
                          ],
                        ),
                      ),
                    ),
                Card(
                  child: Padding(
                    ...
                    Container(
                      ...
                      child: Text(businessProfile!.svProfileRating!.toStringAsFixed(1) + ' ★ Social Value Silver Status', textScaleFactor: 1.25, style: TextStyle(color: silverColor)),
                    ),
                  ),
                    ),
                    FutureBuilder(
